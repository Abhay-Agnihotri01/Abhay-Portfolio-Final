...
const containt = [
  {
    ...
    bigTitle: 'Data & AI',
    desc: [
      <div className="p-l">I turn raw data into meaningful insights by exploring</div>,
      <div className="p-l">patterns, relationships, and trends hidden within it,</div>,
  ...
  },
  {
    ...
    desc: [
      <div className="p-l">I explore how machine learning can turn data into</div>,
      <div className="p-l">predictions and intelligent solutions, from building</div>,
      <div className="p-l">models to understanding how they actually perform.</div>,
    ],
    descMobile: [
  ...
  },
  {
    ...
    desc: [
      <div className="p-l">Good analysis is only valuable when people can understand it.</div>,
      <div className="p-l">I focus on turning complex findings into clear stories</div>,
